...
ci',ci",ci(,ci[,ci{,ci< "change in brackets"
di',di",di( dib,di[,di{ diB,di< "delete in brackets"
yi',yi",yi(,yi[,yi{,yi< "copy in brackets"
vi',vi",vi(,vi[,vi{,vi< "select in brackets"
ca',ca",ca(,ca[,ca{,ca< "change in brackets with brackets"
da',da",da( dab,da[,da{ daB,da< "delete in brackets with brackets"
ya',ya",ya(,ya[,ya{,ya< "copy an brackets with brackets"
va',va",va(,va[,va{,va< "select an brackets with brackets"
